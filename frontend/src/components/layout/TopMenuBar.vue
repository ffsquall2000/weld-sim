...
const menus: MenuGroup[] = [
  {
    ...
    items: [
      { id: 'new', label: 'layout.menu.newProject', shortcut: 'Ctrl+N', action: () => router.push('/calculate') },
      { id: 'open', label: 'layout.menu.open', shortcut: 'Ctrl+O', action: () => router.push('/history') },
      { id: 'sep1', label: '', type: 'separator' },
      { id: 'save', label: 'layout.menu.save', shortcut: 'Ctrl+S', action: () => layoutStore.saveLayout() },
      { id: 'sep2', label: '', type: 'separator' },
      { id: 'export', label: 'layout.menu.export', action: () => router.push('/history') },
    ],
  },
  {
    id: 'view',
  ...
  },
  {
    ...
    items: [
      { id: 'run', label: 'layout.menu.run', shortcut: 'F5', action: () => router.push('/calculate') },
  ...
  },
  {
    ...
    items: [
      { id: 'horn-design', label: 'nav.hornDesign', action: () => router.push('/horn-design') },
      { id: 'knurl-design', label: 'nav.knurlDesign', action: () => router.push('/knurl-design') },
      { id: 'acoustic', label: 'nav.acoustic', action: () => router.push('/acoustic') },
      { id: 'sep-tools', label: '', type: 'separator' },
      { id: 'geometry', label: 'nav.geometry', action: () => router.push('/geometry') },
